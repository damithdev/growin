                  ...
                  children: <Widget>[
                    DotsIndicator(
                      ...
                      decorator: DotsDecorator(
                        ...
                        activeColor: DefaultColorScheme.primaryColor,
                      ),
                    ),
                    Row(
                      mainAxisSize: MainAxisSize.max,
                      ...
                      children: <Widget>[
                        page_number!=0?Padding(
                          ...
                          child: Align(
                            ...
                            child: FlatButton(
                              child: Text("Back",style: TextStyle(color: DefaultColorScheme.primaryColor,fontSize: 16,fontWeight: FontWeight.w300),),
                              onPressed: ()=>{
                        ...
                        page_number==2?Padding(
                          ...
                          child: Align(
                            alignment: Alignment.bottomRight,
                            child: FlatButton(
                              child: Text("Done",style: TextStyle(color: DefaultColorScheme.primaryColor,fontSize: 16,fontWeight: FontWeight.w300),),
                              onPressed: ()=>{
                                Navigator.of(context).pushReplacement(MaterialPageRoute(
                                    builder: (BuildContext context) => UserGetStarted()))
                          ...
                          child: Align(
                            alignment: Alignment.bottomRight,
                            child: FlatButton(
                              child: Text("Next",style: TextStyle(color: DefaultColorScheme.primaryColor,fontSize: 16,fontWeight: FontWeight.w300),),
                              onPressed: ()=>{
                                _controller.animateToPage(page_number.toInt()+1, duration: Duration(milliseconds: 300), curve: Curves.linear)
